...
trainimg = path+'/mnist/train-images.idx3-ubyte'
trainlabel = path+'/mnist/train-labels.idx1-ubyte'
testimg = path+'/mnist/t10k-images.idx3-ubyte'
testlabel = path+'/mnist/t10k-labels.idx1-ubyte'
trainfolder = path+'/mnist/train'
testfolder = path+'/mnist/test'
