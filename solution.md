...
**答：离散傅里叶变换：https://blog.csdn.net/u014783685/article/details/50791535

离散二维傅里叶变换：https://blog.csdn.net/thecentry/article/details/80709593

可以从傅里叶级数进行推导，需要用到欧拉公式，把三角函数变成指数函数

正交变换：把图像分解为几个基图像之和，互相正交
- 1.线性变换
X是N*1向量，T是N*N矩阵，定义了向量X的线性变换
正交矩阵：逆矩阵=矩阵的转置，并且每个基相乘都等于0

完备性：空间中的所有向量都可以使用一组基来表示

任何图像都可以看成是加权系数为像素值的一系列单位基图像的加权和。图像可以表示为基图像的线性组合

迪利克雷条件：有限个间断点，有限个极值点，绝对可积
